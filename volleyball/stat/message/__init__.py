...
__all__ = ["Message",  "QuickOpenMessage", "AttackMessage",  "QuickMessage",  "MoveMessage",  "OpenMessage"
           ...
           ,  "ExitMessage",  "PenaltyMessage",  "WarningMessage",  "TimeMessage", "NoneMessage"
           , "make_message_multiple_set", "Player", "Messages", "AnonymousMessage", "FaultMessage"
           , "PersonalWarningMessage", "EtcMessage"]
